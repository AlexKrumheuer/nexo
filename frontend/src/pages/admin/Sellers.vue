    ...
    <section class="admin-dashboard">
            ...
            <div class="main-info">
                ...
                <div class="grid-item card-stats">
                    ...
                    <div class="card-content">
                        ...
                        <p class="stat-trend positive">
                            <fa icon="chart-line" /> Lifetime sales
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-item card-table-container">
                ...
                <div class="filter-table">
                    ...
                    <div class="filter-table-right">
                        ...
                        <button class="filter-table--add">Add Seller</button>
                    </div>
                </div>
                    ...
                    <table class="admin-table">
                        ...
                        <tbody>
                            <tr class="table-item">
                                ...
                                <td><span>R$ 200000</span></td>
                                
                                <td class="actions-cell"> 
                                    <div class="actions-content">
                                        <div class="action-btn edit" title="Edit Seller">
                                            <fa icon="edit"/>
                                            <span>edit</span>
                                        </div>
                                        <div class="action-btn ban" title="Ban Seller">
                                            <fa icon="trash"/>
                                            <span>ban</span>
                                        </div>
        ...
        <div class="pagination-area">
            <p class="pagination-info">
                Showing <span class="highlight">1</span> to <span class="highlight">10</span> of <span class="highlight">1,000</span> results
            </p>
...
.action-btn.edit:hover { color: #0284c7; }

.action-btn.ban { color: #991b1b; }
.action-btn.ban:hover { color: #dc2626; }
